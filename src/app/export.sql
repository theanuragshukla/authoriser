...
--
-- Name: client_access_seeds client_access_seeds_uid_appId; Type: CONSTRAINT; Schema: public; Owner: anurag
--

ALTER TABLE ONLY public.client_access_seeds
    ADD CONSTRAINT "client_access_seeds_uid_appId" PRIMARY KEY (uid, "appId");
